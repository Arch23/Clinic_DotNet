<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Template.Master" AutoEventWireup="true" CodeBehind="RegPatient.aspx.cs" Inherits="Clinica.Pages.RegPatient" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="template-component">
        <asp:Label ID="Label8" runat="server" Text="Mother" CssClass="template-label"></asp:Label>
        <asp:TextBox ID="txtMother" runat="server" CssClass="text-input"></asp:TextBox>
    </div>
    <div class="template-component">
        <asp:Label ID="Label9" runat="server" Text="Father" CssClass="template-label"></asp:Label>
        <asp:TextBox ID="txtFather" runat="server" CssClass="text-input"></asp:TextBox>
    </div>
    <div class="template-component">
        <asp:Label ID="Label10" runat="server" Text="Hypertensive" CssClass="template-label"></asp:Label>
        <asp:TextBox ID="txtHypertensive" runat="server" CssClass="text-input"></asp:TextBox>
    </div>
